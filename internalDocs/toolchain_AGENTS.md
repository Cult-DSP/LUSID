# toolchain_AGENTS.md — Cult DSP Toolchain (LUSID ⇄ sonoPleth ⇄ SpatialSeed)

**Canonical location:** `LUSID/internalDocsMD/toolchain_AGENTS.md`  
...
### 3.3 Detailed import specification
For comprehensive import rules, validation, delta frames handling, and audio resolution logic, see:
- `internalDocsMD/importingLUSIDpackage.md` (sonoPleth-specific agent spec)
...
- add ad-hoc “DEV\_…” booleans scattered across repos
